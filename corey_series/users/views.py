...
from .forms import UserRegisterForm, ProfileUpdatedForm, UserUpdatedForm
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, f'Account created for {username} successful!. You are currently logged in')
...
# message.debug, message.success, message.warning, message.info, message.error
